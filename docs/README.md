...
The latest Debug build and all 19 discoverable MSTest tests passed. See [virtualization verification](virtualization.md). The following measurements are historical, from before virtualization and the test-project migration.
