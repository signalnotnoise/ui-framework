...
| Responsive layout and scoped styling | implemented | Core defines weighted rows/columns, fixed edge docking, bound split-pane layout, adaptive grids, alignment and theme tokens. WPF owns measurement, native splitter input, templates and interaction states. Applications own native content, durable pane sizing and data templates. | [UI Framework/Layout/ViewAlignment.cs](../UI%20Framework/Layout/ViewAlignment.cs), [UI Framework/Styling/ThemeTokens.cs](../UI%20Framework/Styling/ThemeTokens.cs), [UI Framework/Styling/ButtonStyleKind.cs](../UI%20Framework/Styling/ButtonStyleKind.cs), [UI Framework.Wpf/Layout/AdaptivePanel.cs](../UI%20Framework.Wpf/Layout/AdaptivePanel.cs), [UI Framework/Layout/SplitAxis.cs](../UI%20Framework/Layout/SplitAxis.cs), [UI Framework/Layout/SplitPaneLayout.cs](../UI%20Framework/Layout/SplitPaneLayout.cs), [UI Framework.Wpf/Layout/FlexColumnPanel.cs](../UI%20Framework.Wpf/Layout/FlexColumnPanel.cs), [UI Framework.Wpf/Layout/SplitPanePanel.cs](../UI%20Framework.Wpf/Layout/SplitPanePanel.cs), [tests/UI Framework.Checks/WorkspaceLayoutTests.cs](../tests/UI%20Framework.Checks/WorkspaceLayoutTests.cs), [docs/workspace-layout.md](../docs/workspace-layout.md), [UI Framework.Wpf/Styling/ThemeStyles.cs](../UI%20Framework.Wpf/Styling/ThemeStyles.cs), [UI Framework.Wpf/Styling/ButtonContentPresenter.cs](../UI%20Framework.Wpf/Styling/ButtonContentPresenter.cs), [tests/UI Framework.Checks/ButtonContentTests.cs](../tests/UI%20Framework.Checks/ButtonContentTests.cs), [samples/Counter/Models/LaunchTheme.cs](../samples/Counter/Models/LaunchTheme.cs), [tests/UI Framework.Checks/LayoutStyleTests.cs](../tests/UI%20Framework.Checks/LayoutStyleTests.cs), [UI Framework.Wpf/Styling/ToggleStyles.cs](../UI%20Framework.Wpf/Styling/ToggleStyles.cs), [tests/UI Framework.Checks/ToggleStyleTests.cs](../tests/UI%20Framework.Checks/ToggleStyleTests.cs), [docs/layout-styling.md](../docs/layout-styling.md) |
...
| Observable state | implemented | Tracks value reads and notifies on unequal assignments. Notifications verify thread ownership and finish delivering to all observers before propagating errors. | [UI Framework/IState.cs](../UI%20Framework/IState.cs), [UI Framework/ObservableState.cs](../UI%20Framework/ObservableState.cs), [UI Framework/State.cs](../UI%20Framework/State.cs), [UI Framework/Dependencies.cs](../UI%20Framework/Dependencies.cs), [UI Framework/ViewSession.cs](../UI%20Framework/ViewSession.cs), [UI Framework/StateNotifications.cs](../UI%20Framework/StateNotifications.cs), [tests/UI Framework.Checks/StateNotificationTests.cs](../tests/UI%20Framework.Checks/StateNotificationTests.cs) |
...
| Focus and IME | partial | Real-window tests cover regenerated editor keys, visual paths and TextBox selection; unkeyed/native segments require stable structure. IME and assistive-technology verification remain release gates. | [README.md](../README.md), [tests/UI Framework.Checks/ComponentChecks.cs](../tests/UI%20Framework.Checks/ComponentChecks.cs), [tests/UI Framework.Checks/Probes/MountMutation.cs](../tests/UI%20Framework.Checks/Probes/MountMutation.cs), [tests/UI Framework.Checks/Probes/OtherProbe.cs](../tests/UI%20Framework.Checks/Probes/OtherProbe.cs), [tests/UI Framework.Checks/Probes/Probe.cs](../tests/UI%20Framework.Checks/Probes/Probe.cs), [UI Framework.Wpf/Virtualization/RowFocusSnapshot.cs](../UI%20Framework.Wpf/Virtualization/RowFocusSnapshot.cs), [tests/UI Framework.Checks/VirtualizationTests.cs](../tests/UI%20Framework.Checks/VirtualizationTests.cs), [UI Framework.Wpf/Rendering/FocusIdentity.cs](../UI%20Framework.Wpf/Rendering/FocusIdentity.cs) |
| Error recovery | partial | Body and validation failures retain the last tree. Patch failures clear the affected host, finish cleanup and permit explicit rebuild; arbitrary application mutations cannot roll back. | [UI Framework/IState.cs](../UI%20Framework/IState.cs), [UI Framework/ObservableState.cs](../UI%20Framework/ObservableState.cs), [UI Framework/State.cs](../UI%20Framework/State.cs), [UI Framework/Dependencies.cs](../UI%20Framework/Dependencies.cs), [UI Framework/ViewSession.cs](../UI%20Framework/ViewSession.cs), [README.md](../README.md), [UI Framework.Wpf/ViewHost.cs](../UI%20Framework.Wpf/ViewHost.cs), [tests/UI Framework.Checks/RendererFailureTests.cs](../tests/UI%20Framework.Checks/RendererFailureTests.cs), [tests/UI Framework.Checks/ViewValidationTests.cs](../tests/UI%20Framework.Checks/ViewValidationTests.cs), [docs/error-recovery.md](../docs/error-recovery.md) |
...
| Stress workload | implemented | 1000 mounted rows, 10000 projected writes, mixed edits, filters, remounts, and lifecycle balance measurements. A separate representative workspace compares native adapters with layout primitives while checking geometry, selection and ownership; it does not replace the release gate. | [samples/Counter/StressRunner.cs](../samples/Counter/StressRunner.cs), [samples/Counter/Diagnostics/Measurement.cs](../samples/Counter/Diagnostics/Measurement.cs), [docs/stress-lab.md](../docs/stress-lab.md), [docs/performance-results.md](../docs/performance-results.md), [docs/performance-guardrails.md](../docs/performance-guardrails.md), [tools/Test-Performance.ps1](../tools/Test-Performance.ps1), [tools/Test-WorkspacePerformance.ps1](../tools/Test-WorkspacePerformance.ps1), [samples/WorkspaceComparison/Program.cs](../samples/WorkspaceComparison/Program.cs), [samples/WorkspaceComparison/LayoutProbe.cs](../samples/WorkspaceComparison/LayoutProbe.cs), [samples/WorkspaceComparison/SubmissionListScenario.cs](../samples/WorkspaceComparison/SubmissionListScenario.cs), [docs/submission-virtualization-2026-09-24.md](../docs/submission-virtualization-2026-09-24.md), [samples/ConsumerDiagnostics/Program.cs](../samples/ConsumerDiagnostics/Program.cs), [samples/ConsumerDiagnostics/FileTreeChecks.cs](../samples/ConsumerDiagnostics/FileTreeChecks.cs), [docs/file-tree-virtualization-2026-09-24.md](../docs/file-tree-virtualization-2026-09-24.md), [tools/Test-ConsumerLayout.ps1](../tools/Test-ConsumerLayout.ps1), [docs/consumer-layout-2026-09-24.md](../docs/consumer-layout-2026-09-24.md), [docs/layout-isolation-2026-09-24.md](../docs/layout-isolation-2026-09-24.md), [docs/editor-timeout-investigation.md](../docs/editor-timeout-investigation.md), [tools/performance-baseline.json](../tools/performance-baseline.json) |
...
| Experimental release preparation | partial | Current package version 0.1.0-alpha.2; experimental MIT-licensed source and NuGet preview with Windows validation, fresh package consumers, immutable workflow action pins and separate trusted publishing. | [Directory.Build.props](../Directory.Build.props), [global.json](../global.json), [.github/workflows/validate.yml](../.github/workflows/validate.yml), [tools/Test-Release.ps1](../tools/Test-Release.ps1), [tools/Test-Packages.ps1](../tools/Test-Packages.ps1), [.github/workflows/publish-nuget.yml](../.github/workflows/publish-nuget.yml), [docs/releasing.md](../docs/releasing.md), [CHANGELOG.md](../CHANGELOG.md), [CONTRIBUTING.md](../CONTRIBUTING.md), [LICENSE](../LICENSE), [tools/New-SourceArchive.ps1](../tools/New-SourceArchive.ps1), [tools/Test-Documentation.ps1](../tools/Test-Documentation.ps1), [.github/dependabot.yml](../.github/dependabot.yml) |
